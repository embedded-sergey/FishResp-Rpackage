...
pyroscience.aquaresp <- function(pyroscience.file,
  ...
  if (n.chamber == 1){
    pyroscience.data <- read.table(pyroscience.file, sep = "\t", dec = ",", skip=14, header=F, strip.white=T)
    ...
    pyroscience.data <- read.table(pyroscience.file, sep = "\t", dec = ",", skip=16, header=F, strip.white=T)
    ...
    pyroscience.data <- read.table(pyroscience.file, sep = "\t", dec = ",", skip=18, header=F, strip.white=T)
    ...
    pyroscience.data <- read.table(pyroscience.file, sep = "\t", dec = ",", skip=20, header=F, strip.white=T)
